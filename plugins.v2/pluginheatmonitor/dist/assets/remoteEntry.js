const currentImports = {};
      ...
      let moduleMap = {
"./Page":()=>{
      dynamicLoadingCss(["__federation_expose_Page-5BhIleuN.css","TrendChart-COlK0-cT.css"], false, './Page');
      return __federation_import('./__federation_expose_Page-DhtGSFPQ.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},
"./Config":()=>{
