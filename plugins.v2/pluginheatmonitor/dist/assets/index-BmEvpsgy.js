...
const {createElementVNode:_createElementVNode,createTextVNode:_createTextVNode$7,resolveComponent:_resolveComponent,withCtx:_withCtx,createVNode:_createVNode$2h,openBlock:_openBlock,createBlock:_createBlock} = await importShared('vue');


const {ref: ref$Q} = await importShared('vue');
      ...
      _createVNode$2h(_component_v_main, null, {
        default: _withCtx(() => [
          _createVNode$2h(_component_v_container, null, {
            default: _withCtx(() => [
              _createVNode$2h(_component_v_row, null, {
                default: _withCtx(() => [
                  _createVNode$2h(_component_v_col, { cols: "12" }, {
                    default: _withCtx(() => [
                      _cache[5] || (_cache[5] = _createElementVNode("h1", null, "插件热度监控 - 本地开发", -1)),
